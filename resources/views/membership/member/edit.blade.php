...
<div class="header mt-3">
    <div class="header-body">
        <h1 class="header-title">แก้ไขข้อมูลสมาชิกรหัส {{ $member->code }}</h1>
    </div>
</div>
                            ...
                            <div class="form-group">
                                ...
                                <select id="name_prefix"
                                    ...
                                    @foreach(NamePrefix::toArray() as $key => $value)
                                        <option value="{{ $value }}" @if(old('name_prefix', $member->name_prefix) == $value) selected @endif>{{ __('name-prefix.' . $key) }}</option>
                                    @endforeach
                                </select>
